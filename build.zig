...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "rgp" is the name you will use in your source code to
                // import this module (e.g. `@import("rgp")`). The name is
    ...
    // End-to-end tests in main.zig invoke the installed CLI binary, so build it
    // before running the executable's tests.
