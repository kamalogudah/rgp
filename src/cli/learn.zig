...
pub fn run(_: Io, _: std.mem.Allocator, args: []const []const u8, w: *Io.Writer) !u8 {
    ...
    if (chosen) |id| {
        ...
        try w.print("Lesson: {s} ({s})\nPrerequisite: {s}\n\nConcept\n{s}\n\nBasic syntax\n{s}\n\nMental model\n{s}\n\nExamples\n{s}\n\nCorpus evidence\n{s}\n\nReal-world examples\n{s}\n\nAlternatives\n{s}\n\nExercise\n{s}\n\nFeedback\n{s}\n\nOptional depth\n{s}\n", .{ l.title, l.id, l.prerequisite orelse "none", l.concept, l.syntax, l.mental_model, l.examples, l.corpus_evidence, l.real_examples, l.alternatives, l.exercise, l.feedback, l.optional_depth });
        return 0;
    }
